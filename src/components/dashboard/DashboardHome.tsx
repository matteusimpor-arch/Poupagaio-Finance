  ...
  return (
    <div className="w-full h-full animate-in fade-in duration-300">
      ...
      {/* ==================================================
          ...
          ================================================== */}
      <div className="hidden md:flex md:flex-col md:h-[calc(100vh-120px)] md:max-h-[calc(100vh-120px)] md:justify-between md:gap-3.5 min-h-0 w-full">
        ...
        <div className="grid grid-cols-12 gap-3.5 shrink-0">
          ...
          {/* CARD 1: SALDO DO MÊS */}
          <div className="col-span-4 bg-white dark:bg-[#1E2220] border border-[#E2E8E4] dark:border-[#2E3532] rounded-2xl p-3.5 flex flex-col justify-between shadow-3xs">
          ...
          <div className="col-span-3 bg-white dark:bg-[#1E2220] border border-[#E2E8E4] dark:border-[#2E3532] rounded-2xl p-3.5 flex flex-col justify-between shadow-3xs">
          ...
          <div className="col-span-5 bg-white dark:bg-[#1E2220] border border-[#E2E8E4] dark:border-[#2E3532] rounded-2xl p-3.5 flex flex-col justify-between shadow-3xs">
            ...
            <div className="overflow-y-auto max-h-[105px] pr-1 space-y-1.5 flex-1 min-h-0">
              {isLoading ? (
        ...
        {/* LINHA 4: PRÓXIMOS VENCIMENTOS + CALENDÁRIO DO MÊS (Absorbe o espaço vertical do desktop) */}
        <div className="grid grid-cols-12 gap-3.5 flex-1 min-h-0">
          
          {/* COLUNA ESQUERDA: PRÓXIMOS VENCIMENTOS */}
          <div className="col-span-5 bg-white dark:bg-[#1E2220] border border-[#E2E8E4] dark:border-[#2E3532] rounded-2xl p-3.5 flex flex-col shadow-3xs min-h-0">
          ...
          <div className="col-span-7 bg-white dark:bg-[#1E2220] border border-[#E2E8E4] dark:border-[#2E3532] rounded-2xl p-3.5 flex flex-col shadow-3xs min-h-0">
            <div className="flex items-center justify-between pb-1.5 border-b border-[#E2E8E4]/60 dark:border-[#2E3532]/60 shrink-0 mb-3">
              <div>
                <h3 className="text-xs font-bold font-display text-[#202724] dark:text-[#F4F4F5] uppercase tracking-wider">
                  Calendário do Mês
            ...
            <div className="flex-1 flex flex-row gap-4 min-h-0">
                  ...
                  {Array.from({ length: daysInMonth }).map((_, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-6 h-6 md:w-7.5 md:h-7.5 rounded-full flex flex-col items-center justify-center text-[10px] md:text-xs font-bold relative transition-all cursor-pointer ${
                          isDaySelected
              ...
              {/* Day details right */}
              <div className="w-[42%] bg-[#F8F9F8] dark:bg-[#18201D] border border-[#E2E8E4] dark:border-[#2A312E] rounded-xl p-2.5 flex flex-col justify-between min-h-0">
