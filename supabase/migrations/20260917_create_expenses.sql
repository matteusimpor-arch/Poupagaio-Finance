...
--   2. public.fixed_expense_payments (Pagamentos por competência mensal YYYY-MM)
...
-- Políticas RLS para fixed_expense_payments (USING + WITH CHECK)
...
-- Políticas RLS para variable_expenses (USING + WITH CHECK)
